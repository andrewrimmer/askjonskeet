    ...
    <footer className="bg-skeet-dark text-gray-500 text-xs py-6 mt-auto">
      <div className="max-w-4xl mx-auto px-4 text-center space-y-3">
        ...
        <nav className="flex justify-center gap-4 text-sm">
          <Link to="/" className="text-gray-400 hover:text-skeet-orange transition-colors">Ask</Link>
          <Link to="/latest" className="text-gray-400 hover:text-skeet-orange transition-colors">Latest</Link>
          <Link to="/about" className="text-gray-400 hover:text-skeet-orange transition-colors">About</Link>
        </nav>
